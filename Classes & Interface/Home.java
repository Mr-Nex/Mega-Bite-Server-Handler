...
import com.example.rexx.megabiteserver.Model.Category;
import com.example.rexx.megabiteserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    private void showDialog() {
        ...
        btnSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                chooseImage(); // select image from gallery
            }
        });
...
// press ctrl+O
    ...
    private void loadMenu() {
        ...
        adapter.notifyDataSetChanged(); // to refresh data, if changed..
